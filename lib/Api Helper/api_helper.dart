...
import 'package:jewellary/Add%20To%20Cart/add_to_cart_modal.dart';
import 'dart:convert';
...
class ApiService {
  ...
  Future<List<Product>> fetchJewellaryProducts(String itemTitle) async {
    try {
      final response = await http.get(
        Uri.parse('$_baseUrl/get_jewellary_detail.php?item_title=$itemTitle'),
      );
  ...
  Future<List<Product>> fetchAddToCartProducts(int userId) async {
    try {
      final response = await http.get(
        Uri.parse('$_baseUrl/fetch.php?user_id=$userId'),
      );
  ...
  static Future<void> addUserDetail(
    ...
    try {
      Uri url = Uri.parse('$_baseUrl/signup.php');
  ...
  static Future<void> addToCart(
    ...
    try {
      Uri url = Uri.parse('$_baseUrl/user_cart.php');
      var response = await http.post(
        url,
        body: {
  ...
  static Future<Map<String, dynamic>> login(
    ...
    try {
      Uri url = Uri.parse('$_baseUrl/login.php');
      var response = await http.post(
        url,
        body: {
  ...
  static Future<bool> deleteFromCart(String pId, String userId) async {
    final url = Uri.parse('$_baseUrl/delete_add_to_cart.php');
  ...
  static Future<bool> addAddress(
    ...
    try {
      Uri url = Uri.parse('$_baseUrl/user_address.php');
      var response = await http.post(
        url,
        body: {
  ...
  static Future<List<Map<String, dynamic>>> getUserAddress(
      String userId) async {
    final Uri url = Uri.parse("$_baseUrl/get_user_address.php?user_id=$userId");
  ...
  static Future<bool> addToWishlist(
    ...
    try {
      Uri url = Uri.parse('$_baseUrl/wishlist.php');
      var response = await http.post(
        url,
        body: {
  ...
  static Future<bool> deleteFromWishlist(String pId, String userId) async {
    final url = Uri.parse('$_baseUrl/delete_wishlist.php');
  ...
  Future<List<Product>> fetchWishlistProducts(int userId) async {
    try {
      final response = await http.get(
        Uri.parse('$_baseUrl/get_wishlist.php?user_id=$userId'),
      );
